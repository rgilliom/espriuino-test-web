...
var Puck = (function() {
  ...
  function checkIfSupported() {
    ...
    if (navigator.platform.indexOf('Win')>=0 &&
      ...
      _console.warn('Chrome <56 in Windows has navigator.bluetooth but it is not implemented properly');
  ...
  var puck = {
    ...
    log : function(level, s) { if (level <= this.debug) _console.log('<BLE> '+s);},
